import { Repo, User, UserTab } from "../Type"
...
export const repositories: Repo[] = [
    {
        ...
        updated_at: '2024-03-20T11:32:52Z',
        html_url: "#"
    },
    {
        name: 'accessibility-alt-text-bot',
        description: 'An action to remind users to add alt text on Issues, Pull Request, and Discussions',
        license: true,
        forks_count: 7,
        stargazers_count: 50,
        updated_at: '2024-03-21T11:32:52Z',
        html_url: "#"
    },
    {
...
export const defaultSearch:UserTab = {
    profile: "",
    username: "Github",
    bio: "How people build software.",
}
